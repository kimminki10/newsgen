...
def crawler(url: str):
    if url.startswith("https://finance.yahoo.com/"):
        crawled, title, time, article = yahoo_crawler.crawl_yahoo_article(driver, url)
        ...
        title, time, article = basic_crawler.crawler(driver, url, title_selector, time_selector, article_selector)
